...
export default function App() {
  ...
  return (
    <>
      ...
      <Main>
        <Box>
          <AnimeList animes={animes} onSelecetedAnime={handleSelectedAnime} />
        </Box>
        <Box>
...
function Main({ children }) {
  return (
    <main className="main">
      {/* <ListBox animes={animes} onSelecetedAnime={handleSelectedAnime} />
...
function AnimeList({ animes, onSelecetedAnime }) {
  return (
    <ul className="list list-anime">
      {animes?.map((anime) => (
        <Anime
          key={anime.id}
          anime={anime}
          onSelecetedAnime={onSelecetedAnime}
        />
      ))}
    </ul>
  );
...
function Anime({ anime, onSelecetedAnime }) {
  return (
    <li key={anime.mal_id} onClick={() => onSelecetedAnime(anime.mal_id)}>
